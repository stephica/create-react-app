...
const ResetPasswordForm = props => {
  ...
  return (
    <Form warning onSubmit={handleSubmit(() => resetPassword(newPassword))} loading={loadingState} error={errorState} success={successState}>
      ...
      {successState && <Button color="green" onClick={hideLoginModal}>Close Modal</Button>}
    </Form>
  )
}
