...
export const showEditWalletModal = makeActionCreator($showEditWalletModal, 'wallet')
...
export const getEditWalletInfo = state => state.editWalletModal.walletInfo || null
